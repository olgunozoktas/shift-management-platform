    ...
    <section class="flex flex-col gap-2">
        ...
        <form action="{{ $route }}" class="flex flex-col gap-4 mt-4" method="POST">
            ...
            <label class="block">
                ...
                <input type="text" name="title" value="{{ old('name', isset($job) ? $job->job_title : '') }}"
            ...
            <label class="block">
                <span class="text-gray-700">Job Number</span>
                <input type="number" name="number" value="{{ old('number', isset($job) ? $job->job_number : '') }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
